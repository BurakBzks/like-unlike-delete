                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form action="{{route('register')}}" method="post" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control p_input" name="name" value="{{old('name')}}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="surname" class="form-control p_input" name="surname" value="{{old('surname')}}">
                                @error('surname')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="password_confirmation" class="form-control p_input" name="password_confirmation">
                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-block enter-btn" id="btnLogin">Register</button>
                            </div>
